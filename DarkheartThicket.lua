...
local pi = math.pi
AscensionDungeonTools.dungeonTotalCount[dungeonIndex] = {normal=280,teeming=336,teemingEnabled=true}
AscensionDungeonTools.dungeonBosses[dungeonIndex] = {--Darkheart Thicket
	[1] = {
		[1] = {
...
AscensionDungeonTools.dungeonEnemies[dungeonIndex] = { --Darkheart Thicket
	[1] = {
