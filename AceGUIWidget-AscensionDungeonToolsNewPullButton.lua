local Type, Version = "AscensionDungeonToolsNewPullButton", 1
...
local function Constructor()
    local name = "AscensionDungeonToolsNewPullButton"..AceGUI:GetNextWidgetNum(Type);
