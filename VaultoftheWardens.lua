...
AscensionDungeonTools.dungeonTotalCount[dungeonIndex] = {normal=210,teeming=252,teemingEnabled=true}
AscensionDungeonTools.dungeonBosses[dungeonIndex] = {--Vault of the Wardens
	[1] = {
		[1] = {
