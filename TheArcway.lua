...
local pi = math.pi
AscensionDungeonTools.dungeonTotalCount[dungeonIndex] = {normal=392,teeming=466,teemingEnabled=true}
AscensionDungeonTools.dungeonBosses[dungeonIndex] ={ --The Arcway
    [1] = {
        [1] = {
            ["name"] = "Ivanyr",
            ["health"] = 99914542,
...
AscensionDungeonTools.dungeonEnemies[dungeonIndex] = { --The Arcway
    [1] = {
