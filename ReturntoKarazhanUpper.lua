...
local pi = math.pi
AscensionDungeonTools.dungeonTotalCount[dungeonIndex] = {normal=169,teeming=202,teemingEnabled=true}
local nerfMultiplier = 0.74 --npcs got nerfed by 26% compared against m0 values, bosses unchanged
AscensionDungeonTools.dungeonBosses[dungeonIndex] = {--Upper Karazhan
	[3] = {
		[1] = {
            ["name"] = "The Curator",
            ["health"] = 129540841,
