...
local pi = math.pi
AscensionDungeonTools.dungeonTotalCount[dungeonIndex] = {normal=206,teeming=242,teemingEnabled=true}
AscensionDungeonTools.dungeonBosses[dungeonIndex] = {--Eye of Azshara
	[1] = {
		[1] = {
...
AscensionDungeonTools.dungeonEnemies[dungeonIndex] = { --Eye of Azshara
	[1] = {
