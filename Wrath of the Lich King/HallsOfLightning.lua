...
local pi = math.pi
AscensionDungeonTools.dungeonTotalCount[dungeonIndex] = {normal=300,teeming=360,teemingEnabled=true}
AscensionDungeonTools.dungeonBosses[dungeonIndex] = {--Auchenai Crypts
	[1] = {
		[1] = {
...
AscensionDungeonTools.dungeonEnemies[dungeonIndex] = { --Auchenai Crypts
	[1] = {
