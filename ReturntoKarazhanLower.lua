...
AscensionDungeonTools.dungeonTotalCount[dungeonIndex] = {normal=420,teeming=504,teemingEnabled=true}
AscensionDungeonTools.dungeonBosses[dungeonIndex] = {--Lower Karazhan
	[3] = {
		[1] = {
